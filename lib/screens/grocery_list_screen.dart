            ...
            TextButton(
              onPressed: () async {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => NewOrderScreen(listId: randomListId, days: days, flatId: '', apartmentId: '', floorNo: '', flatNo: '', role: '',),
                  ),
                );
              },
      ...
      onSuccess: () {
        setState(() {
          Navigator.pushAndRemoveUntil(
            context,
            MaterialPageRoute(builder: (context) => NewOrderScreen(listId:randomListId, days: days, flatId: '', apartmentId: '', floorNo: '', flatNo: '', role: '',)),
                (route) => false,
          );
        });
